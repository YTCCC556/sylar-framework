...
int HttpRequestParser::isFinished() const { return 0; }
int HttpRequestParser::hasError() const { return 0; }
...
int HttpResponseParser::isFinished() const { return 0; }
int HttpResponseParser::hasError() const { return 0; }
