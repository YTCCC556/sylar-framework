    ...
    while (!stopping()) {
        ...
        if (ft.fiber && (ft.fiber->getState() != Fiber::TERM &&
            ...
            SYLAR_LOG_INFO(g_logger)
                    << ft.fiber->getID() << " ft.fiber begin IN";
            ...
            ++m_activeThreadCount;
            SYLAR_LOG_INFO(g_logger)
                    << cb_fiber->getID() << " cb_fiber begin IN";
            cb_fiber->swapIn();
            --m_activeThreadCount;
            SYLAR_LOG_INFO(g_logger) << cb_fiber->getID() << " cb_fiber end IN";
            ...
            ++m_idleThreadCount;
            SYLAR_LOG_INFO(g_logger)
                    << idle_fiber->getID() << " idle_fiber begin IN";
            idle_fiber->swapIn();
            --m_idleThreadCount;
            SYLAR_LOG_INFO(g_logger)
                    << idle_fiber->getID() << " idle_fiber end IN";
